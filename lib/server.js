            ...
            item.response.forEach(response => {
              ...
              for (let key of Object.keys(req.query)) {
                ...
                if (
                  ...
                  if (match) {
                    //We found a matched query so increase the score.
                    score++
                  }
                } else {
              ...
              //   this.debug && console.log("best matched: " + bestMatchedResponse["name"]);
              //   this.debug && console.log("best matched score: " + bestMatchedResponseScore);
              // }
            })
          }
